                ...
                <div class="row align-items-center">
                    <div class="col-md-12">
                        ...
                        <ul class="breadcrumb">
                            ...
                            <li class="breadcrumb-item"><a href="<?php echo base_url() . $page['b']['link'] ?>"><?php echo $page['b']['title'] ?></a></li>
                            <li class="breadcrumb-item"><a href="<?php echo base_url() . $page['c']['link'] ?>"><?php echo $page['c']['title'] ?></a></li>
                        </ul>
                    </div>
                </div>
            </div>
                            ...
                            <div class="col-md-12 col-xl-12">
                                <div class="card mb-3">
                                    ...
                                    <div class="card-body">
                                        ...
                                        <p class="card-text"><?= $c->article ?></p>
                                        <!-- <p class="card-text"><small class="text-muted">Last updated 3 mins ago</small></p> -->
                                        <a class="btn btn-primary btn-sm has-ripple" href="<?= base_url('#') . $c->slug ?>">Like<span class="ripple ripple-animate"></span></a>
                                    </div>
                                </div>
                            </div>
