...
$(document).ready(function() {
    ...
    $(".background-color.flat > a").on("click", function() {
        ...
        $(this).addClass("active");
        if (a == "background-default") { $(".pcoded-header").removeClassPrefix("header-") } else {
    ...
    $("#menu-fixed").change(function() {
        ...
        } else { $(".pcoded-navbar").removeClass("menupos-fixed") }
    });
    ...
    $.fn.removeClassPrefix = function(a) {
        this.each(function(c, d) {
            var b = d.className.split(" ").map(function(e) { return e.indexOf(a) === 0 ? "" : e });
            d.className = b.join(" ")
        });
        return this
    }
